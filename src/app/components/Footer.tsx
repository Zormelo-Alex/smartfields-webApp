    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <img src="/Logo.png" className='w-[30px] h-[30px]' alt="" />
            </div>
              <span className="text-xl font-semibold">SmartFields</span>
            </div>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                href="mailto:support@smartfields.com"
        ...
        <div className="pt-8 border-t border-primary-foreground/10 text-center text-sm text-primary-foreground/70">
          <p>© 2026 SmartFields. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
